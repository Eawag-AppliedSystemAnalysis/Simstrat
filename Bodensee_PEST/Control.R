...
dat = read.table("../Bodensee.txt",sep=",")
...
sim_T = strptime(c("1984-01-01","2012-01-01"),format="%Y-%m-%d")
...
parval = c(47.55, 990,0.030,1.25,1.0,0.0017,0.002,0.0,1e-15,1.1,0.9,0.3,0.2)
parmin = c(40.00, 900,0.001,0.70,1.0,0.0010,0.001,0.0,1e-30,0.5,0.5,0.0,0.0)
parmax = c(50.00,1000,0.100,1.30,2.0,0.0030,0.005,1.0,1e-09,1.5,1.5,0.4,0.3)
