c ************************************************************
c     writes values of fix parameters into common blocks
c ***********************************************************

c      *** Constants  for freshwater ***
...
c      *** parameter for MY model ***
          ...
          B2=10.1		
          c1=0.08	
c      *** further parameters controlling water dynamic ***
