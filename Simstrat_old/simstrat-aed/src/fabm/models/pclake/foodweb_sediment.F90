...
!!
! !INTERFACE:
   module pclake_foodweb_sediment
!
! !DESCRIPTION:
!-----------------------------------------------------------------------
! Module description
...
! !PUBLIC DERIVED TYPES:
   type, extends(type_base_model),public :: type_pclake_foodweb_sediment
...
!     Module procedures
      ...
      procedure :: do_bottom
      end type type_pclake_foodweb_sediment
...
! !INPUT PARAMETERS:
   class (type_pclake_foodweb_sediment), intent(inout),      target :: self
...
!
! !INPUT PARAMETERS:
   class (type_pclake_foodweb_sediment), intent(in)    :: self
...
!EOC
!-----------------------------------------------------------------------
   end module pclake_foodweb_sediment
!------------------------------------------------------------------------------
