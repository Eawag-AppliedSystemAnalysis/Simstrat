...
!
! !INTERFACE:
   module au_pclake_foodweb_water
!
! !DESCRIPTION:
!  The au_pclake_foodweb_water module describes the state variables regarding zooplanktons
...
! !PUBLIC DERIVED TYPES:
   type, extends(type_base_model),public :: type_au_pclake_foodweb_water
...
!     Model procedures
   ...
   end type type_au_pclake_foodweb_water
...
!
! !INPUT PARAMETERS:
   class (type_au_pclake_foodweb_water), intent(inout), target :: self
...
!
!  INPUT PARAMETERS:
   class (type_au_pclake_foodweb_water), intent(in)    :: self
...
!-----------------------------------------------------------------------
   ...
   end module au_pclake_foodweb_water
