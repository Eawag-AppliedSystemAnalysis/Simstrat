...
class Tester(object):
    ...
    def run_simulation(self, end_time):
        ...
        self.create_simulation_config({"Input.Forcing" : self.input_file("forcing.dat"), "Simulation.End d" : end_time})
    ...
    def run_simulation_with_defined_times(self, times):
        ...
        self.create_simulation_config({"Output.Times" : times})
        self.execute_simstrat(USED_CONFIG_FILE)
...
tester.execute_simstrat(ORIGINAL_CONFIG_FILE)
