...
dat = read.table("../LacDeNeuchatel.txt",sep=",")
...
sim_T = strptime(c("1994-01-01","2015-01-01"),format="%Y-%m-%d")
...
parval = c(46.90, 990,0.015,1.25,1.0,0.0017,0.002,0.10,1e-15,1.1,0.9,0.3,0.2)
