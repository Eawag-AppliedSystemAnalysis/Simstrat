...
dat = read.table("../LacLeman.txt",sep=",")
...
sim_T = strptime(c("1981-01-01","2014-01-01"),format="%Y-%m-%d")
...
parval = c(46.45, 990,0.030,1.25,1.0,0.0017,0.002,0.5,1e-15,1.1,0.9,0.3,0.2)
