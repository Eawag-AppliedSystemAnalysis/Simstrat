...
First set the variable names, the name of the file containing the converted output, the path to the output files, as well as the conversion function in `Simstrat/tools/ConvertOutput/convert_output.py`.
